...
public class TpsCamera : MonoBehaviour
        {
            [FormerlySerializedAs("_playerInput")] public CharacterInputSystem characterInput; [SerializeField] private Transform LookAttarGet;
...
public LayerMask collisionLayer;     
    private void Awake()
    {
        ...
        characterInput = LookAttarGet.transform.root.GetComponent<CharacterInputSystem>();
 ...
 private void Update()
        ...
        private void GetCameraControllerInput()
            ...
            yaw += characterInput.cameraLook.x * mouseInputSpeed;
            pitch -= characterInput.cameraLook.y * mouseInputSpeed;
            pitch = Mathf.Clamp(pitch, ClmpCameraRang.x, ClmpCameraRang.y);
            Debug.Log("yaw = " + characterInput.cameraLook.x );
        }
